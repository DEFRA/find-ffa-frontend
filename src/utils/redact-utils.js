...
import { AsyncRedactor } from 'cognosys-redact-pii'
...
const redactor = new AsyncRedactor({
  customRedactors: {
    before: [
      {
        regexpPattern:
          /\b([Gg][Ii][Rr] 0[Aa]{2})|((([A-Za-z][0-9]{1,2})|(([A-Za-z][A-Ha-hJ-Yj-y][0-9]{1,2})|(([A-Za-z][0-9][A-Za-z])|([A-Za-z][A-Ha-hJ-Yj-y][0-9]?[A-Za-z])))) [0-9][A-Za-z]{2})\b/gim,
        replaceWith: 'POSTCODE'
      },
      {
        regexpPattern: /\b[0-9]{5}\s?[0-9]{5,6}\b/gim,
